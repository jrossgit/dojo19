...
class SpriteLayer(Layer):
    ...
    def __init__(self, index=1):
        ...
        self.image_sister1.width = int(self.image.width * 1.5)
        self.image_sister1.height = int(self.image.height * 1.5)
        ...
        self.image_sister2.width = int(self.image.width * 2)
        self.image_sister2.height = int(self.image.height * 2)

        self.image_sister3 = pyglet.resource.image('grossinis_sister3.png')
        self.image_sister3.anchor_x = self.image_sister3.width // 2
        self.image_sister3.anchor_y = self.image_sister3.height // 2
        self.image_sister3.height = int(self.image.height * 2.5)
        self.image_sister3.width = int(self.image.width * 2.5)
...
class SpriteJump(SpriteLayer):
    ...
    def on_enter(self):
        ...
        sprite3 = Sprite(self.image_sister3)

        self.add(sprite)
        self.add(sprite1)
        self.add(sprite2)
        self.add(sprite3)
        self.position = 120, 150


        jump=JumpBy((300, 0), height=200, jumps=4, duration=3)
        sprite.do(Repeat(jump + Reverse(jump)))

        jump=JumpBy((200, 0), height=150, jumps=4, duration=3)
        sprite1.do(Repeat(jump + Reverse(jump)))

        jump=JumpBy((100, 0), height=100, jumps=4, duration=3)
        sprite2.do(Repeat(jump + Reverse(jump)))

        jump=JumpBy((0, 0), height=50, jumps=4, duration=3)
        sprite3.do(Repeat(jump + Reverse(jump)))
...
tests = {
    # 5: ("Test #1 - MoveTo", "sprite.do( MoveTo( (x,y), duration ) )", SpriteMoveTo),
